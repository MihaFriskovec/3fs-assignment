...
type ListGroupsHandlerFunc func(ListGroupsParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ListGroupsHandlerFunc) Handle(params ListGroupsParams) middleware.Responder {
	return fn(params)
}

// ListGroupsHandler interface for that can handle valid list groups params
type ListGroupsHandler interface {
	Handle(ListGroupsParams) middleware.Responder
}
...
/*ListGroups swagger:route GET /groups Groups listGroups

ListGroups list groups API
