...
type ReadUserHandlerFunc func(ReadUserParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadUserHandlerFunc) Handle(params ReadUserParams) middleware.Responder {
	return fn(params)
}

// ReadUserHandler interface for that can handle valid read user params
type ReadUserHandler interface {
	Handle(ReadUserParams) middleware.Responder
}
...
/*ReadUser swagger:route GET /users/{id} Users readUser

ReadUser read user API
