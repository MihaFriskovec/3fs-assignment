...
// ReadUserParams contains all the bound params for the read user operation
...
func (o *ReadUserParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
